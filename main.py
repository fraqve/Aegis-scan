...
if __name__ == "__main__":
    # CLI argument parser target is required, wordlist is optional
    ...
    # Load API keys from config.json (pushed only a template never push the file with my actual API)
    ...
    # Generate master report combining all scan and enrichment data
    print("Generating master report ...")
    report.gen_report(args.target, nmap, gobuster, nikto, virustotal, abuseipdb)
    print("Done\n")

    # Read master report and send to Gemini for AI-powered security analysis
